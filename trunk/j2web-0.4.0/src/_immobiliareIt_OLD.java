...
public class _immobiliareIt_OLD extends PortaleImmobiliare {     
	...
	//Costruttore
	public _immobiliareIt_OLD (String urlIcona, String valoreLabel, String idPortale, boolean isActive) {		
