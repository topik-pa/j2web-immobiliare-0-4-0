...
public class _casabIt extends PortaleImmobiliare {     
	...
	public void inizializzaParametri() throws HttpCommunicationException {			
		...
		if(scheda.categoriaImmobile!="Residenziale") {
			Locali = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile!="Residenziale") {
			Eta_Costruzione = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile!="Residenziale") {
			Posto_Auto = dontSendThisParam;
			Garage = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile!="Residenziale" && scheda.categoriaImmobile!="Terreni" && scheda.categoriaImmobile!="Commerciale") {
			Riscaldamento_Autonomo = dontSendThisParam;
			riscaldamento_autonomo = dontSendThisParam;
		}
		...
		Terrazzo = "";
		if(scheda.categoriaImmobile!="Residenziale") {
			Terrazzo = dontSendThisParam;
		}
		mappaDeiParamerti.put("Terrazzo", Terrazzo);
		
		
		costruzione_presente = "";
		if(scheda.categoriaImmobile!="Terreni") {
			Terrazzo = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile=="Terreni") {
			arredato = dontSendThisParam;
		}
		mappaDeiParamerti.put("arredato", arredato);
		
		
		attivita_consentite = "";
		if(scheda.categoriaImmobile!="Commerciale") {
			attivita_consentite = dontSendThisParam;
		}
		...
		mq_edificabili = "";
		if(scheda.categoriaImmobile!="Terreni") {
			mq_edificabili = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile!="Terreni") {
			possibili_realizzazione = dontSendThisParam;
		}
		...
		progetto_approvato = "";
		if(scheda.categoriaImmobile!="Terreni") {
			progetto_approvato = dontSendThisParam;
		}
		mappaDeiParamerti.put("progetto_approvato", progetto_approvato);
		
		
		mq_coperti = "";
		if(scheda.categoriaImmobile!="Commerciale" && scheda.categoriaImmobile!="Industriale") {
			mq_coperti = dontSendThisParam;
		}
		...
		mq_copribili = "";
		if(scheda.categoriaImmobile!="Commerciale" && scheda.categoriaImmobile!="Industriale") {
			mq_copribili = dontSendThisParam;
		}
		...
		if(scheda.categoriaImmobile!="Residenziale") {
			piani_totali = dontSendThisParam;
		}
		mappaDeiParamerti.put("piani_totali", piani_totali);
		
		
		posizione = "";
		if(scheda.categoriaImmobile!="Residenziale" && scheda.categoriaImmobile!="Commerciale" && scheda.categoriaImmobile!="Industriale") {
			posizione = dontSendThisParam;
		}
		...
		tipo_terreno = "";
		if(scheda.categoriaImmobile!="Terreni") {
			tipo_terreno = dontSendThisParam;
		}
