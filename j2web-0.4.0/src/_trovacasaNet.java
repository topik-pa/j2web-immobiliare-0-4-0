...
public class _trovacasaNet extends PortaleImmobiliare {     

    //Variabili generali
	private final String NOMEPORTALE = "trovacasa.net";
	private final String SESSIONCOOKIENAME = "ASP.NET_SessionId";
	private final String SESSIONCOOKIEDOMAIN = ".trovacasa.net";
	private final String URLROOT = "http://www.trovacasa.net";
	...
	//Costruttore
	public _trovacasaNet (String urlIcona, String valoreLabel, String idPortale, boolean isActive) {		
